...
export const seedPersonas: SeedPersona[] = [
  ...
  },
  {
    ...
    tagline: "Dating profile — looking for a wife, not a situationship",
    heroHeading: "Looking For A Wife",
    heroBody:
      "Marriage-minded software developer and founder in Uyo. Faith, family, dark humour, and someone ready to build a real life — not endless small talk.",
    ctaLabel: "Open Dating Profile",
    ctaHref: "#about",
    iconName: "Heart",
    sortOrder: 3,
    isActive: true,
...
export const seedBlocks: SeedBlock[] = [
  ...
  // ── romantic (dating profile — rich UI lives in DatingProfileView) ──
  ...
  block("rom-stat-2", "romantic", "stat", {
    title: "Wife",
    body: "What I'm looking for",
    iconName: "Heart",
    sortOrder: 2,
  }),
  block("rom-stat-3", "romantic", "stat", {
    title: "Uyo",
    body: "Faith · family · build",
    iconName: "MapPin",
    sortOrder: 3,
  }),
  block("rom-text-1", "romantic", "text", {
    title: "Looking for a wife",
    body: "Not casual. Not situationships. Marriage-minded software developer and founder who cooks, boxes, values faith and family, and wants children. Deep talks, dry humour, and someone ready to build a real life.",
    iconName: "Heart",
    sortOrder: 10,
  }),
  block("rom-sec-1", "romantic", "section", {
    title: "Deep Conversations",
    body: "Philosophy, faith, tech, life — hours if you want them",
    iconName: "MessageCircle",
    sortOrder: 20,
  }),
  block("rom-sec-2", "romantic", "section", {
    title: "Ambitious and Driven",
    body: "Multiple products, still grounded and present",
    iconName: "TrendingUp",
    sortOrder: 21,
  }),
  ...
  block("rom-sec-5", "romantic", "section", {
    ...
    body: "Foundation for marriage, children, and legacy",
    iconName: "Heart",
    sortOrder: 24,
  }),
